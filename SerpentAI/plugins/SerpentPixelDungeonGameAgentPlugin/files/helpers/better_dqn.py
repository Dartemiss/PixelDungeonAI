# -*- coding: utf-8 -*-
"""
Created on Fri Nov  9 20:15:21 2018
...
from keras.layers import Dense, Flatten, Convolution2D, MaxPooling2D, AveragePooling2D, Input, concatenate
...
class BDQN(DDQN):
    ...
    def _initialize_model(self):
        ...
        merged_layer = concatenate([tower_1, tower_2, tower_3])
